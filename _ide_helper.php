 ...
 * Generated for Laravel 7.11.0 on 2020-06-21 12:01:05.
 *
...
namespace Irazasyed\LaravelGAMP\Facades { 
    ...
    class GAMP {
        ...
        {
                        /** @var \TheIconic\Tracking\GoogleAnalytics\Analytics $instance */
         ...
         * @static 
         */ 
        public static function makeNonBlocking()
        {
                        /** @var \TheIconic\Tracking\GoogleAnalytics\Analytics $instance */
                        return $instance->makeNonBlocking();
        }
         ...
         *
         * @internal 
         * @param \TheIconic\Tracking\GoogleAnalytics\HttpClient $httpClient
         * @return \TheIconic\Tracking\GoogleAnalytics\Analytics 
         * @static 
         */ 
        ...
        {
                        /** @var \TheIconic\Tracking\GoogleAnalytics\Analytics $instance */
                        return $instance->setDebug($value);
        }
...
namespace App\Facades { 
    ...
    class UserPermission {
         ...
         * @static 
         */ 
        public static function testIfUserHasAnyPermission($permissions = [], $user = null)
        {
                        /** @var \App\Libraries\User\UserPermissionLibrary $instance */
                        return $instance->testIfUserHasAnyPermission($permissions, $user);
        }
         ...
         * @static 
         */ 
        public static function testIfIsUserOrHasUserAnyPermission($checkUser, $permissions = [], $user = null)
        {
                        /** @var \App\Libraries\User\UserPermissionLibrary $instance */
                        return $instance->testIfIsUserOrHasUserAnyPermission($checkUser, $permissions, $user);
        }
         ...
         * @static 
         */ 
        public static function testIfIsSystemUser($user = null)
        {
                        /** @var \App\Libraries\User\UserPermissionLibrary $instance */
                        return $instance->testIfIsSystemUser($user);
        }
         ...
         * @static 
         */ 
        public static function allowIfUserHasAnyPermission($permissions = [], $user = null)
        {
                        /** @var \App\Libraries\User\UserPermissionLibrary $instance */
                        return $instance->allowIfUserHasAnyPermission($permissions, $user);
        }
         ...
         * @static 
         */ 
        public static function allowIfIsUserOrUserHasAnyPermission($checkUser, $permissions = [], $user = null)
        {
                        /** @var \App\Libraries\User\UserPermissionLibrary $instance */
                        return $instance->allowIfIsUserOrUserHasAnyPermission($checkUser, $permissions, $user);
        }
...
namespace  { 
    ...
    class GAMP extends \Irazasyed\LaravelGAMP\Facades\GAMP {}
    ...
    class UserPermission extends \App\Facades\UserPermission {}

    class AWS extends \Aws\Laravel\AwsFacade {}

    class VideoPlatformsParser extends \Chojnicki\VideoPlatformsParser\Facade {}
